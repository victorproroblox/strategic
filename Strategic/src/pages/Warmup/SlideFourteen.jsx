...
const CORRECT_RULES = {
  ...
  DoesHas: ['He', 'She', 'It'], // Actualizado para incluir "Does / Has"
...
const SlideFourteen = () => {
  ...
  // Función actualizada para renderizar ambas combinaciones
        ...
        <div className={`${styles.topRow} ${step >= 1 ? styles.visible : styles.hidden}`}>
          {['DoHave', 'DoesHas'].map(word => (
            <div 
              ...
              // Aplicamos el borde redondeado amarillo a ambos elementos superiores
